...
public class KronosApp {

    private static final Logger log = LoggerFactory.getLogger(KronosApp.class);

    private final Environment env;

    public KronosApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KronosApp.class);
